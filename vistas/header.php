...
<html>
  <head>
    ...
    <title>Cuantisoft | www.cuanticomp.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>CuantiSoft</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.cuanticomp.com - Quito, Ecuador
                      <small>Porque el mundo es informático</small>
                    </p>
                  </li>
